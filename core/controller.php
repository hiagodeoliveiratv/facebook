...
class controller {
	...
	public function loadView($viewName, $viewData = array()) { // cria a função load view, e recebe os parametros view name e view data, para caso o usuario não envie nada, utilize os valores padrões...
